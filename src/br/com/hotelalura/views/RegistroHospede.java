...
public class RegistroHospede extends JFrame {
	...
	private static Reserva reservaDoHospede;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					RegistroHospede frame = new RegistroHospede(reservaDoHospede);
	 ...
	 * Create the frame.
	 */
	public RegistroHospede(Reserva reservaDoHospede) {
		
		this.reservaDoHospede = reservaDoHospede;
		
		setIconImage(Toolkit.getDefaultToolkit().getImage(RegistroHospede.class.getResource("/br/com/hotelalura/views/imagenes/lOGO-50PX.png")));
		...
		txtDataN.getCalendarButton().setIcon(new ImageIcon(RegistroHospede.class.getResource("/br/com/hotelalura/views/imagenes/icon-reservas.png")));
		...
		txtNreserva.setText(reservaDoHospede.getId().toString());
		...
		btnsalvar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e){
				...
				String dataNascimento = dataF.format(txtDataN.getDate());
				...
				Hospede hospede = new Hospede(nome, sobrenome, dataNascimento, nacionalidade, telefone, 
						reservaDoHospede.getId());
				
				JOptionPane.showMessageDialog(null, "O número da sua reserva é: " + reservaDoHospede.getId());
		...
		imageFundo.setIcon(new ImageIcon(RegistroHospede.class.getResource("/br/com/hotelalura/views/imagenes/registro.png")));
		
		JLabel logo = new JLabel("");
		logo.setBounds(194, 39, 104, 107);
		panel.add(logo);
		logo.setIcon(new ImageIcon(RegistroHospede.class.getResource("/br/com/hotelalura/views/imagenes/Ha-100px.png")));
	}
