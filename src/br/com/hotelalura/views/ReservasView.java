...
public class ReservasView extends JFrame {
	...
	public ReservasView() {
		super("Reserva");
		setIconImage(Toolkit.getDefaultToolkit().getImage(ReservasView.class.getResource("/br/com/hotelalura/views/imagenes/aH-40px.png")));
		...
		txtDataE.getCalendarButton().setIcon(new ImageIcon(ReservasView.class.getResource("/br/com/hotelalura/views/imagenes/icon-reservas.png")));
		...
		txtDataS.getCalendarButton().setIcon(new ImageIcon(ReservasView.class.getResource("/br/com/hotelalura/views/imagenes/icon-reservas.png")));
		...
		txtDataS.addPropertyChangeListener(new PropertyChangeListener() {
			public void propertyChange(PropertyChangeEvent evt) {
				...
				DateTime dataEntrada = new DateTime(dataE);
		...
		txtValor.setBounds(67, 328, 70, 33);
		txtValor.setEditable(false);
		txtValor.setFont(new Font("Roboto Black", Font.BOLD, 17));
		txtValor.setBorder(javax.swing.BorderFactory.createEmptyBorder());
		panel.add(txtValor);
		txtValor.setColumns(17);
		...
		panel_1.add(logo);
		logo.setIcon(new ImageIcon(ReservasView.class.getResource("/br/com/hotelalura/views/imagenes/Ha-100px.png")));
		
		JLabel imagenFondo = new JLabel("");
		imagenFondo.setBounds(0, 140, 500, 409);
		panel_1.add(imagenFondo);
		imagenFondo.setBackground(Color.WHITE);
		imagenFondo.setIcon(new ImageIcon(ReservasView.class.getResource("/br/com/hotelalura/views/imagenes/reservas-img-3.png")));
	...
	//Código que permite movimentar a janela pela tela seguindo a posição de "x" e "y"	
	 ...
	 private void registraReserva() {
		 try {
			ReservaController reservaController = new ReservaController();
			DateFormat formatoDaData = new SimpleDateFormat("yyyy-MM-dd");
			Date dataEntrada = txtDataE.getDate();
			String dataE = formatoDaData.format(dataEntrada);
			
			Date dataSaida = txtDataS.getDate();
			String dataS = formatoDaData.format(dataSaida);
			
			String[] combo = {"Cartão de Crédito", "Cartão de Débito", "Dinheiro"};
			String formaPagamento = combo[txtFormaPagamento.getSelectedIndex()];
			
			this.reservaAtual = new Reserva(dataE, dataS, valor, formaPagamento);
			
			reservaController.salvar(this.reservaAtual);
