...
public class Sucesso extends JDialog {
	 ...
	 */
	public Sucesso() {
		setIconImage(Toolkit.getDefaultToolkit().getImage(Sucesso.class.getResource("/br/com/hotelalura/views/imagenes/aH-40px.png")));
		...
		contentPanel.setLayout(null);
		{
			...
			lblNewLabel.setIcon(new ImageIcon(Sucesso.class.getResource("/br/com/hotelalura/views/imagenes/Ha-100px.png")));
