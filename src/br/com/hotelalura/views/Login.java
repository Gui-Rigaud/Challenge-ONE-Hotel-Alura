...
import br.com.hotelalura.controllers.LoginController;
...
public class Login extends JFrame {
	...
	public Login() {
		...
		imgHotel.setIcon(new ImageIcon(Login.class.getResource("/br/com/hotelalura/views/imagenes/img-hotel-login-.png")));
		...
		logo.setIcon(new ImageIcon(Login.class.getResource("/br/com/hotelalura/views/imagenes/lOGO-50PX.png")));
	...
	private void Login() throws SQLException {
		...
		List<User> usuarios = loginController.signUp();
		
		boolean result = false;
		
		for (User user : usuarios) {
			if(user.getLogin().equals(usuario) && user.getPassword().equals(senha)) {
				result = true;
				break;
			}
		}
